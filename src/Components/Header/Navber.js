      ...
      <Navbar className='container ' style={{ marginBottom: '-2px', borderRadius: '20px' }} bg="light" variant="light">
        <Container>
          <Nav className="me-auto  mx-auto ">
            ...
            <Link style={{ color: 'green' }} className='ms-3 text-decoration-none py-2 fw-bolder' to="/home">About Us</Link>

            <Link style={{ color: 'green' }} className='ms-3 text-decoration-none py-2 fw-bolder' to="/home">Contact Us</Link>
